...
const EN = {
  ...
  'settings.language.desc': 'Use the Obsidian language automatically, or force Chinese or English. Settings update immediately; command palette names update after the plugin reloads.',
...
const ZH_CN: Record<TranslationKey, string> = {
  ...
  'settings.language.desc': '默认跟随 Obsidian，也可以固定使用中文或 English。设置页会立即切换；命令面板名称会在插件重载后更新。',
